...
int main(int argc, char** argv)
{
    ...
    {
        std::cout << "Iteration " << i_cloud << " ..." << std::endl; // DEBUG DELETE
        ...
        prodrone::ElapseTimer e0("Normal estimation", true);
...
//    model->saveModelToFile(file);
    ...
    prodrone::ElapseTimer e2("Testing normals", true);
    ...
    boost::shared_ptr<pcl::features::ISMVoteList<pcl::PointXYZ> > vote_list = ism.findObjects(model, testing_cloud,
                                                                                              testing_normals, testing_class);
